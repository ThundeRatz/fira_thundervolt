...
def test_rotate_return():
    vec = (0,0)
    rotated_vec = math.rotate(vec, 3.875)

    assert type(rotated_vec) is np.ndarray
    assert rotated_vec.shape == (2,)

    vec = [545, 7544]
    rotated_vec = math.rotate(vec, 9.547)

    assert type(rotated_vec) is np.ndarray
    assert rotated_vec.shape == (2,)

    vec = np.array([50, 60])
    rotated_vec = math.rotate(vec, 100)
...
def test_rotate():
    vec = np.array([1, 2])
    rotated_vec = math.rotate(vec, np.pi / 2)
    ...
    vec = np.array([1, 2])
    rotated_vec = math.rotate(vec, np.pi)
    rotated_vec_2 = math.rotate(vec, -np.pi)
