...
class FollowBallVerticalDefender(ExecutionNode):
    ...
    def setup(self):
        self.action = LineAction(
                        kp_ang=8.0, ki_ang=0.001, kd_ang=3.0, tolerance_ang=0.04,
                        kp_lin=200.0, ki_lin = 0.000, kd_lin=2.0, tolerance_lin=0.05,
